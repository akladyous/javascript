...
function Person(firstName, lastName) {
  console.log(
    '- When function constructor is invoched, it creates a new empty object with the name as the function name ',
  );
  console.log('- this : ', this, 'is the Object have been created');
  console.log(
    "- function constructor bind properties defined inside the function with 'this' keyword to the new created object",
  );
