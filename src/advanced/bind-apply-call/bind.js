...
function test() {
    ...
    console.log("arguments passed from bind method are:     ", Array.prototype.slice.call(arguments))
}
...
const user = {
    ...
    sayHello: function (something) { console.log(`hello ${this.firstName} ${something}`) }
}
